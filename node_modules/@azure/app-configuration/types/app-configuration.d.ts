 ...
 */
export declare interface ListLabelsOptions extends OperationOptions, OptionalLabelsFields {
 ...
 * A page of configuration settings and the corresponding HTTP response
 */
export declare interface ListLabelsPage extends HttpResponseField<SyncTokenHeaderField>, PageSettings, EtagEntity {
    /**
 ...
 */
export declare interface OptionalLabelsFields {
    /**
     * Which fields to return for each ConfigurationSetting
     */
...
export declare interface SettingLabel {
    /**
